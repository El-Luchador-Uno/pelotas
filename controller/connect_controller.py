...
from pin_management import servo_pin, standard_pin
from constants import A_BUTTON_CODE, B_BUTTON_CODE, Y_BUTTON_CODE
    ...
    for event in controller.read_loop():
        if event.type == ecodes.EV_KEY or event.type == ecodes.EV_ABS:
            if event.code == A_BUTTON_CODE and event.value == 1:
                standard_pin.control_pin(17, 1.0)
            elif event.code == B_BUTTON_CODE and event.value == 1:
                standard_pin.control_pin(17, 0)
